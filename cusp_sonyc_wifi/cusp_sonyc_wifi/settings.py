"""
Django settings for cusp_sonyc_wifind project.
"""
...
ALLOWED_HOSTS = (
    'localhost', '128.122.72.157', '127.0.0.1', 'wifindproject.com'
)
...
ROOT_URLCONF = 'cusp_sonyc_wifi.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'cusp_sonyc_wifi.wsgi.application'
